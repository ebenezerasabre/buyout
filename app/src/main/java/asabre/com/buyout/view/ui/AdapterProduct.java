...
public class AdapterProduct extends RecyclerView.Adapter<AdapterProduct.ViewHolder> {
    ...
    private AddFpToWishListCallback mAddFpToWishListCallback;
    ...
    private View.OnClickListener addProductToWishList(final Product product, final ViewHolder holder){
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mAddFpToWishListCallback.addFpToWishList(product, holder);
            }
        };
    }
