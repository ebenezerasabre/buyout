...
public class AdapterTrendingProducts extends
        RecyclerView.Adapter<AdapterTrendingProducts.ViewHolder> {
    ...
    public AdapterTrendingProducts(Context context,
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if(mProductList == null || mProductList.size() == 0){
            ...
            holder.homeTrendAddWishList.setOnClickListener(addTrendingToWishList(product, holder));
   ...
   public static class ViewHolder extends RecyclerView.ViewHolder{
    ...
    private View.OnClickListener addTrendingToWishList(final Product product, final ViewHolder holder){
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mAddWishListFromHomeCallback.addTrendingToWishList(product, holder);
            }
        };
    }
